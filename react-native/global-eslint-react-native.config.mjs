// Configuration ESLint globale pour projets React Native avec Expo
// Supporte à la fois React et React Native dans le même projet
...
export default [
  ...
  // Configuration générale pour tous les fichiers
  {
    ...
    languageOptions: {
      globals: {
        // Variables globales du navigateur (pour React Web)
        window: 'readonly',
        document: 'readonly',
        console: 'readonly',
        setTimeout: 'readonly',
